...
describe('Example React App', function () {
    ...
    it('has correct default text', function () {
        ...
        var wrapper = enzyme_1.mount(react_1.default.createElement(mobx_react_1.Provider, { store: store },
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    expect.assertions(2);
                    fetch.mockResponse(JSON.stringify([]));
                    wrapper = enzyme_1.mount(react_1.default.createElement(mobx_react_1.Provider, { store: store },
                        react_1.default.createElement(ExampleApp_1.default, null)));
                    expect(wrapper.text()).not.toMatch('Buy Milk');
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    wrapper = enzyme_1.mount(react_1.default.createElement(mobx_react_1.Provider, { store: todoStore },
                        react_1.default.createElement(ExampleApp_1.default, null)));
