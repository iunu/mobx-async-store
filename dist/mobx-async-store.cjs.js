          ...
          switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              mobx.transaction(function () {
                ...
                mobx.set(target, 'id', json.data.id); // NOTE: This resolves an issue where a record is persisted but the
...
function () {
  ...
  _createClass(Model, [{
    ...
    value: function _makeObservable(initialAttributes) {
      ...
      mobx.extendObservable(this, _objectSpread$2({}, defaultAttributes, {}, initialAttributes));
    ...
    value: function _createOrUpdateOneRecordFromResponseData(dataObject) {
      ...
      if (record) {
        ...
        Object.keys(attributes).forEach(function (key) {
          ...
          mobx.set(_this5.data[type].records, id, record);
