  ...
  _createClass__default["default"](Store, [{
    ...
    value: function fetchMany(type, ids) {
      ...
      return Promise.all(queries).then(function (records) {
        var _ref5;
        return (_ref5 = []).concat.apply(_ref5, _toConsumableArray__default["default"](records));
      }).catch(function (err) {
    ...
    value: function updateRecordsFromResponse(promise, records) {
      ...
      return promise.then( /*#__PURE__*/function () {
        var _ref11 = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee4(response) {
