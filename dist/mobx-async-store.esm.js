  ...
  _createClass(Store, [{
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                ids = _toConsumableArray(new Set(ids)).map(String);
    ...
    value: function updateRecordsFromResponse(promise, records) {
      ...
      return promise.then( /*#__PURE__*/function () {
        var _ref11 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee5(response) {
...
var Model = /*#__PURE__*/function () {
  ...
  function Model() {
    ...
    _defineProperty$1(this, "initialized", false);
