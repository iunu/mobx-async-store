...
var Store = (_class = /*#__PURE__*/function () {
  ...
  function Store(_options) {
    ...
    _defineProperty(this, "bulkSave", function (type, records) {
    ...
    _defineProperty(this, "_bulkSave", function (type, records) {
      var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
    ...
    _defineProperty(this, "bulkCreate", function (type, records) {
      var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
    ...
    _defineProperty(this, "bulkUpdate", function (type, records) {
      var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
