...
var Store = /** @class */ (function () {
    ...
    Store.prototype.initializeModelTypeIndex = function () {
        this.modelTypeIndex = this.types.reduce(function (modelTypeIndex, modelKlass) {
    ...
    Store.prototype.initializeObservableDataProperty = function () {
        ...
        this.types.forEach(function (modelKlass) {
     ...
     */
    Store.prototype.getRecord = function (type, id, queryParams) {
