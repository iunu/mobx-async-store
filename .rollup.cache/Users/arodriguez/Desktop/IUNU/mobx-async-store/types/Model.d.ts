...
declare class Model {
     ...
     * @type {object}
     */
    get persistedOrFirstSnapshot(): number | ((...items: never[]) => number) | {
        (...items: ConcatArray<never>[]): never[];
        (...items: ConcatArray<never>[]): never[];
    } | ((separator?: string | undefined) => string) | ((callbackfn: (value: never, index: number, array: never[]) => void, thisArg?: any) => void) | ((value: never, start?: number | undefined, end?: number | undefined) => never[]) | ((index: number) => undefined);
    /**
